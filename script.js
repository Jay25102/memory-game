// I did not take on the further study in this submission due to lack of time, but I may in the future
...
function handleCardClick(event) {
  ...
  // following line changes background color of div to class
